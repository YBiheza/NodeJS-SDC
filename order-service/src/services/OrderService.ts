...
import type { IOrderStrategy } from "../interfaces/IOrderStrategy"
...
export class OrderService {
    private strategies: IOrderStrategy[]
    ...
    async markAsReady(data: {
        ...
        /*return this.orderRepository.updateStatus(data.orderId)
    }
}*/